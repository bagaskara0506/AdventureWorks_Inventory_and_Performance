...
## 4 Strategic Business Questions (Supply Chain Analyst)
...
Proses visualisasi dilakukan dengan membuka Tableau Public Edition 2026.1.0 dan melakukan koneksi ke *Text File* > *File (CSV)*. Penyimpanan dilakukan menggunakan *Save to Tableau Public As*.
